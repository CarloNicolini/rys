...
def latest_delta_long(tag: str) -> Path | None:
    patterns = [
        f"results/qwen_guesstimation_rys/{tag}/*/delta_score_long.csv",
        f"results/pythia_guesstimation_rys/{tag}/*/delta_score_long.csv",
        f"results/pythia_guesstimation_rys/pythia-{tag}/*/delta_score_long.csv",
    ]
